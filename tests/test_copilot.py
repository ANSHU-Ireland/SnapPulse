...
sys.path.insert(
    0,
    os.path.join(os.path.dirname(__file__), "..", "snap-pulse", "services", "copilot"),
)
...
def test_github_webhook_endpoint():
    ...
    test_payload = {
        "action": "created",
        "comment": {"body": "/snappulse fix this snap please"},
        "repository": {"html_url": "https://github.com/test/test-repo"},
        "issue": {"number": 123},
    }
